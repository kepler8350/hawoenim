...
try { db.exec("ALTER TABLE broadcast_settings ADD COLUMN start TEXT"); } catch(e) {}
try { db.exec("ALTER TABLE broadcast_settings ADD COLUMN end_time TEXT"); } catch(e) {}
try { db.exec("ALTER TABLE broadcast_settings ADD COLUMN gap INTEGER"); } catch(e) {}
